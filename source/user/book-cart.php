...
if(isset($_POST['update_update_btn'])){
   ...
   if ($update_quantity_query) {
      echo '<script>alert("Quantity updated successfully."); window.location.href = "book-cart.php";</script>';
  }
};
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><a href="book-cart.php?remove=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('Are you sure to remove item from cart?')" class="delete-btn"> <i class="fas fa-trash"></i> Remove</a></td>
         </tr>
         <?php
