            ...
            <div class="details">
                    ...
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control custom"  name="id" value="<?php echo $id;?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control custom" placeholder="Username" name="username" value="<?php echo $username; ?>" />
                        </div>
                        <div class="form-group">
                            <label for="password">Password:</label>
                            <input type="password" class="form-control custom"  name="password" value="<?php echo $pword; ?>" />
                        </div>
                        <div class="form-group">
                ...
                if (isset($_POST["update"])){
                    ...
                    contact='$_POST[contact]', fname='$_POST[fname]', mname='$_POST[mname]', lname='$_POST[lname]', email= '$_POST[email]', username = '$_POST[username]', password = '$_POST[password]'
                    where id = '$id'");
                        ?>
                            <script type="text/javascript">
                                window.location="student-profile.php";
