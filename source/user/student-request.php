...
<div class="home">
    <br><br>
<div class="container">
    <h1 style="text-align:center">RESERVE A BOOK</h1>
    <br>
    <div class="st-issuedBook">
	    ...
	    <form action="" method="post" class="issue-content">
	    	<table class="table table-bordered table-striped">
	    		<tr>
                    <td>
                      <input type="text" class="form-control" name="name" value="<?php echo $fname ." "; echo $mname ." "; echo $lname ." ";?>" >
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" class="form-control bdr" name="bname" value="" placeholder="Reserve book name">
                    </td>
                </tr>
                <tr>
                    <td>
                      <input type="text" class="form-control" name="email" value="" placeholder="Quantity" >
                    </td>
                </tr>
            </table>
            ...
            <?php 
	    		...
	    		if (isset($_POST["submit"])) {
                    ...
                    ?>
                        ...
                        alert("Helmet reservation send successfully");   
                        </script>
                    <?php
                        }else{
                    ?>
                        <script type="text/javascript">
                            document.location='student-request.php';
                            alert("The Helmet Reservation is Already Exist. \n The Book is still in process.");
                        </script>
                    <?php
                        }
                    }
