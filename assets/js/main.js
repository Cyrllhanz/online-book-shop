		...
		pageGenerator(itemPerPage);
		let pageLink1 = pageUl.querySelectorAll("a");
		let lastPage =  pageLink1.length - 2;
		...
		pageRunner(pageLink1, itemPerPage, lastPage, pageLi);
		...
		function getpagElement(val){
			...
			pageRunner(pageLink1, val, lastpage, pageli);
